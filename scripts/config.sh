...
if [ -f "$WORKSPACE_DIR/.env.${CURRENT_CONTEXT}" ]; then
    ...
    echo "  ./scripts/config-local.sh      # For local development"
    echo "  ./scripts/config-openportal.sh # For OpenPortal production"
    exit 1
fi
...
# Cluster configuration - auto-generated by config.sh
# DO NOT EDIT MANUALLY - Run config.sh to regenerate
