...
update_backstage_config() {
    ...
    # Create/update app-config.openportal.yaml
    cat > "$WORKSPACE_DIR/app-portal/app-config.openportal.yaml" <<EOF
...
EOF
    ...
    echo -e "${GREEN}✓ Created app-portal/app-config.openportal.yaml${NC}"
}
